...
public class ItemService {
    ...
    // 상품 등록하기 ( create )
    @Transactional
    public void itemRegistration(ItemCreate itemCreate){

        // 상품 DTO -> 상품 Entity
        Item item = new Item(itemCreate);
    ...
    public List<ItemResponse> getAllRegistratedItem(ItemSearch itemSearch){
        ...
        // 리스트안에 있는 item 객체를 itemResponse객체로 변경한다음, 그 변경한 객체(item->itemResponse)를 리스트 안에 담아서 리턴
